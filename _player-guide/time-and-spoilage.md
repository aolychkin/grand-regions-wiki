...
> Status: 🟢 тик 1 мин работает; 🟡 порча на складе в работе.
...
- Восстановление энергии Player +1.04 за тик (= 25/игр. день).
- Прогресс стройки.
...
В **«Я»** → Активы → Склад ты видишь **горизонтальную полосу** для каждого Warehouse:
