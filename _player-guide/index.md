...
- [Переводы между игроками + прозрачность политиков](transfers-and-transparency.md): переводы денег, против коррупции.
- [Корзина и выживание](survival.md): что списывается каждый день, голод и больница.
