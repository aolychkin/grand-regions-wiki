...
|---|---|---|---|
| 🌳 Лес | Возобновляемый | **5–10% к max** | Биологическое возобновление; перерубил → 1–2 игр. месяца |
| 🌾 Каучук | Возобновляемый | **5%** | Растительные плантации |
| 💧 Вода техн. | Возобновляемый | **10%** | Природный круговорот, реки/осадки. Самое быстрое сырьё |
| 🪨 Камень | Полу-исчерп. | **1%** | Каменоломня, медленная доразведка. **Нужен для бетона** |
| ⚙️ Чёрная руда (`iron_ore`) | Полу-исчерп. | **0.5%** | Доразведка пластов |
| 🛢️ Нефть | Полу-исчерп. | **0.3%** | Геологическая доразведка (новые залежи) |
...
Варианты реализации (одно решение из этих, ):
