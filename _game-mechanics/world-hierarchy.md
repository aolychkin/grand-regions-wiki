...
| тип региона | Назначение | Лейбл UI |
|---|---|---|
...
| тип города | Назначение | Лейбл UI |
|---|---|---|
...
Москва, тип региона=federal_city`. **Внутри** Москвы как региона, 12 Cities-округов:
...
> На старте никаких государств не существует. Country=РФ есть в БД с пустым Президент. Все регионы, нейтральные (правящая страна региона=NULL`).
