...
> Status: 🟢 тик 1 мин работает (спека 3); 🟡 порча на складе — спека W4.0 `spoilage-and-timing`.
...
**Игрок видит результаты** в дневных метриках: «Iron Smelter произвёл 100 кг/день». Тик — просто механизм равномерного распределения **в каждый игровой час**.
